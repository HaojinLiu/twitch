...
import com.haojin.twitch.dao.FavoriteDao;
import com.haojin.twitch.entity.db.Item;
import com.haojin.twitch.entity.db.ItemType;
import com.haojin.twitch.entity.response.Game;
...
public class RecommendationService {
    ...
    private List<Item> recommendByFavoriteHistory(Set<String> favoritedItemIds, List<String> favoritedGameIds,
