package com.haojin.twitch.controller;

import com.haojin.twitch.entity.db.Item;
import com.haojin.twitch.entity.request.FavoriteRequestBody;
import com.haojin.twitch.service.FavoriteService;
...
public class FavoriteController {
    ...
    public void setFavoriteItem(@RequestBody FavoriteRequestBody requestBody, HttpServletRequest request,
    ...
    public void unsetFavoriteItem(@RequestBody FavoriteRequestBody requestBody, HttpServletRequest request,
                                  HttpServletResponse response) {
        HttpSession session = request.getSession(false);
        if (session == null) {
            response.setStatus(HttpServletResponse.SC_FORBIDDEN);
